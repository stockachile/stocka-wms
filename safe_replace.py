...
end_str = "    // Shopify Submit Listener"
...
backtick_idx = content.rfind("`;", 0, end_idx)
if backtick_idx == -1:
    print("No backtick match")
    exit(1)

# Find 'Integraciones Ecommerce'
h2_idx = content.find('Integraciones Ecommerce</h2>')
if h2_idx == -1:
    print("No h2 match")
    exit(1)

# Find the closest <div style="margin-bottom: 2rem;"> BEFORE the h2
div_str = '<div style="margin-bottom: 2rem;">'
start_idx = content.rfind(div_str, 0, h2_idx)
...
template_replacement = """<div style="margin-bottom: 2rem;">
...
new_content = content[:start_idx] + template_replacement + content[backtick_idx:]
