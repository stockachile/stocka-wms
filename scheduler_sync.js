...
function runSync() {
  ...
  console.log(`====================================================`);
  console.log(`[${timestamp}] 🔄 Ejecutando sincronización periódica...`);
  console.log(`====================================================`);

  const child = exec('node sync_bluex.js', { cwd: __dirname }, (error, stdout, stderr) => {
...
console.log('====================================================');
console.log(`⏱️ Programador Continuo de Blue Express`);
