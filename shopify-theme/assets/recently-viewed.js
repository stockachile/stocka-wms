...
class RecentlyViewedProducts {
  constructor() {
    _defineProperty(this, "init", async container => {
      let products = getCookie('sf-recent-viewed-products');
      if (!container || !products) return;
      this.container = container;
      this.setData();
      this.products = Array.from(new Set(JSON.parse(products)));

      if (this.products.length) {
        const {
          root
        } = MinimogThemeSettings.routes;
        ...
        recently_viewed_products_MinimogTheme.Products.initProductForms({
          context: this.container
        }).then(() => {
          var _MinimogTheme$Compare, _MinimogTheme$Wishlis;

          (_MinimogTheme$Compare = recently_viewed_products_MinimogTheme.CompareProduct) === null || _MinimogTheme$Compare === void 0 ? void 0 : _MinimogTheme$Compare.setCompareButtonsState();
          (_MinimogTheme$Wishlis = recently_viewed_products_MinimogTheme.Wishlist) === null || _MinimogTheme$Wishlis === void 0 ? void 0 : _MinimogTheme$Wishlis.setWishlistButtonsState();
        }).catch(console.error);
    ...
    _defineProperty(this, "setData", () => {
      ...
      this.swiper = null;
      this.currentScreen = '';
      this.enableSlider = this.container.dataset.enableSlider === "true";
      this.productsPerRow = Number(this.container.dataset.items);
    ...
    _defineProperty(this, "initByScreenSize", () => {
      ...
      if (screen === 'desktop') {
        ...
        if (this.enableSlider && ((_this$products = this.products) === null || _this$products === void 0 ? void 0 : _this$products.length) > this.productsPerRow) {
    ...
    _defineProperty(this, "initProductCountdown", () => {
      load_assets_loadAssets('countdown.js').then(() => {
        ...
        return (_MinimogTheme = recently_viewed_products_MinimogTheme) === null || _MinimogTheme === void 0 ? void 0 : (_MinimogTheme$Product = _MinimogTheme.ProductCountdown) === null || _MinimogTheme$Product === void 0 ? void 0 : (_MinimogTheme$Product2 = _MinimogTheme$Product.init) === null || _MinimogTheme$Product2 === void 0 ? void 0 : _MinimogTheme$Product2.call(_MinimogTheme$Product);
      });
    });
  }
...
recently_viewed_products_MinimogTheme.RecentlyViewedProducts = new RecentlyViewedProducts();
}();
/******/ })()
;