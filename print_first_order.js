...
async function test() {
  ...
  try {
    ...
    const ordersRes = await fetch('https://api-developers.ecomm.cencosud.com/v1/orders?limit=1', {
      method: 'GET',
      headers: {
    ...
    console.log('Keys of ordersData:', Object.keys(ordersData));
    if (ordersData.data) {
      console.log('Length of ordersData.data:', ordersData.data.length);
      console.log('First order object:', JSON.stringify(ordersData.data[0], null, 2));
    } else {
