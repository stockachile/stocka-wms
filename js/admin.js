...
async function renderAdminCatalogWorkspace(commerce) {
  ...
  if (searchInput) {
    ...
    newSearchInput.addEventListener('input', (e) => {
      ...
      renderAdminMatrixRows(filteredProducts, window.currentSecondaryPlatforms, window.currentMappingsMap);
    });
  }
  ...
  if (formNew) {
    formNew.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        alert(isPack ? 'Combo/Pack creado exitosamente! Edítalo para agregar sus componentes.' : 'Producto creado exitosamente!');
