...
const INITIAL_MOCK_DATA = {
  profiles: [
    ...
    },
    {
      ...
      email: 'operaciones@stocka.cl',
      comercio: 'Stocka WMS Chile',
      job_title: 'Director de Operaciones & Logística',
      work_phone: '+56900000002',
    ...
    },
    {
      ...
      email: 'contacto@stocka.cl',
      comercio: 'Stocka WMS Chile',
      job_title: 'Equipo Central Stocka WMS',
      work_phone: '+56900000004',
      whatsapp_number: '+56900000004',
      linkedin_url: 'https://linkedin.com/company/stocka',
      ...
      if (!sessionStorage.getItem('wms_demo_db_aligned_v4')) {
        ...
        const alignedProfiles = [
          ...
          },
          {
            ...
            email: 'valentina.demo@stocka.cl',
            comercio: 'no asignado',
            is_demo_user: true,
