-- WMS STOCKA - Supabase Schema: Integración Walmart
-- Ejecuta este script en el SQL Editor de tu proyecto de Supabase para habilitar Walmart.
...
-- 2. Agregar columnas para almacenar la data cruda de la API de Walmart
ALTER TABLE orders ADD COLUMN IF NOT EXISTS raw_walmart_data JSONB;
ALTER TABLE products ADD COLUMN IF NOT EXISTS raw_walmart_data JSONB;
